<?php
/**
 * Plugin Name: bbP Topic Views
 * Plugin URI: http://bbpep.com/plugins/bbp-topic-views/
...
/**
 * Many thanks to _ck_ (bbshowcase.org) & wittmania for the original bb Topic
 * Views plugin.
 */
...
function btv_topic_view_count( $topic_id = 0 ) {
	...
	$view_count = btv_get_topic_view_count( $topic->topic_id );
...
?>
	...
	<input id="_btv_add_to_title"   name="_btv_add_to" type="radio" value="title"<?php checked( btv_add_to(), 'title' ); ?> />
	<label for="_btv_add_to_title"><?php _e( 'After the topic title', 'bbp-topic-views' ); ?></label><br />

	<input id="_btv_add_to_meta"    name="_btv_add_to" type="radio" value="meta"<?php checked( btv_add_to(), 'meta' ); ?> />
	<label for="_btv_add_to_meta"><?php _e( 'Before the topic meta',  'bbp-topic-views' ); ?></label><br />

	<input id="_btv_add_to_nowhere" name="_btv_add_to" type="radio" value="nowhere"<?php checked( btv_add_to(), 'nowhere' ); ?> />
...
// Code is Poetry
// Thanks for readin' this! Well done!
